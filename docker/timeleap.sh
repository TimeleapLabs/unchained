...
usage() {
  ...
  echo "Node:"
  #echo "  broker  - Manage timeleap broker node"
  #echo "  remote  - Manage timeleap remote node"
  echo "  worker     - Manage timeleap worker node"
  echo "  standalone - Manage timeleap standalone node"
  echo "Options:"
